"Joining a computer to a domain" means adding the computer to an Active Directory network, allowing it to use domain credentials for login, access domain resources, and apply domain policies for security and management.
