...
[CCProxy Download](https://github.com/script-kiddie-hacker/Proxy)
...
* **Port Configuration**: Leave the default ports or specify custom ones as needed.
...
* **Save Changes**: Click "Save" and then "OK" to apply your settings.
